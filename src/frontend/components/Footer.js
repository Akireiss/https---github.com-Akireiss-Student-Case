...
<section className="mx-auto dark:bg-gray-800">
        ...
        <footer class="px-4  divide-y  dark:text-gray-100">
          <div class="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
            <div class="lg:w-1/3">
              <Link to class="flex justify-center space-x-3 lg:justify-start">
                ...
                <span class="font-bold md:font-extrabold text-3xl md:text-5xl max-w-full text-[#0f7383]">Learnosa</span>
              </Link>
            </div>
            <div class="grid grid-cols-2 text-sm gap-x-2 gap-y-6 lg:w-1/3 sm:grid-cols-4">
              <div class="space-y-3">
                <h3 class="tracking-wide uppercase dark:text-gray-50">Services</h3>
                <ul class="space-y-1">
                  <li>
              ...
              <div class="space-y-3">
                <h3 class="uppercase dark:text-gray-50">About Us</h3>
                <ul class="space-y-1">
                  <li>
          ...
          <div class="py-6 text-sm text-center dark:text-gray-400">© 2023 Learnosa Co. All rights reserved.</div>
        </footer>
